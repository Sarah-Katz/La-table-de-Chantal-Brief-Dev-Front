...
function Slider({ images }) {
    ...
    // Function for clicking on a dot to go to a specific image
    ...
    return (
        ...
        <div className="slider-container">
            <div className="image-container">
                ...
                {/* Render the dots component with the images array, currentImage index, and onClick function */}
                <Dot images={images} currentImage={currentImage} onClick={handleImageClick} className="dots-container" />
